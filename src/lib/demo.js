...
export function demoSeed() {
  ...
  return {
    ...
    tasks: [
      { id: uid(), title: 'Cerrar propuesta cliente “Alpha”', project_id: p2, priority: 'alta', status: 'doing', today: true, due: d(0), subtasks: [{ t: 'Alcance', done: true }, { t: 'Presupuesto', done: true }, { t: 'Enviar', done: false }], position: 1, venture: 'alh' },
      { id: uid(), title: 'Revisar métricas de activación', project_id: p1, priority: 'alta', status: 'todo', today: true, due: d(0), subtasks: [], position: 2, venture: 'sedari' },
    ...
    movements: [
      { id: uid(), concept: 'Stripe · suscripciones', category: 'Ingreso', amount: 1840, date: d(0), recurring: true, venture: 'sedari' },
      { id: uid(), concept: 'Cliente Alpha · retainer', category: 'Consultoría', amount: 2500, date: d(-1), recurring: true, venture: 'alh' },
      { id: uid(), concept: 'Nómina', category: 'Nómina', amount: 1500, date: d(-3), recurring: true },
      { id: uid(), concept: 'Meta Ads', category: 'Marketing', amount: -640, date: d(-4), deductible: true, venture: 'comercia' },
      { id: uid(), concept: 'Figma + Linear', category: 'Software', amount: -84, date: d(-6), recurring: true, deductible: true },
      { id: uid(), concept: 'Coworking', category: 'Oficina', amount: -350, date: d(-8), recurring: true, deductible: true },
